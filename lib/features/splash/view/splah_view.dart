...
class SplashView extends StatelessWidget {
  ...
  GestureDetector buildSkip(BuildContext context) => GestureDetector(onTap: (){}, child: Text(TextConstants.skip,  style: context.textTheme.headline5!.copyWith(color: context.appColors.royalBlue)));

  CustomButton buildLogin() {
    return CustomButton(
